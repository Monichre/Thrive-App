...
export default class FinanceTrack extends Component {
            ...
            <div className="FitnessTrack" id="FitnessTrack">
                <div className="main clearfix">
                    <form id="nl-form" className="nl-form">
                        I want to try to
                        <select>
                            <option value="1" selected>do something healthy</option>
                            <option value="2">lose</option>
                            <option value="3">gain</option>
                            <option value="4">eat</option>
                            <option value="5">train</option>
                            <option value="6">run</option>
                        </select>
                        <br />
                        <select>
                            <option value="1" selected>...to what result?</option>
                            <option value="2">5 pounds</option>
                            <option value="3">10 pounds</option>
                            <option value="4">healthier</option>
                            <option value="2">harder</option>
                        ...
                        <br /> not listed?
                        <input type="text" value="" placeholder="here" data-subline="For example: <em>Gym</em> or <em>Central Park</em>"/>
